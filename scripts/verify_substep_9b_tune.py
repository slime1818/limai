"""Substep 9b tuning verify. Altitude-pan range -15% to +15% with -20% buffer.

Four Apu scroll positions for visual band-check.
"""
...
POSITIONS = [
    ("tune-apu-pan-progress-0", 0),
    ("tune-apu-pan-progress-25", 450),
    ("tune-apu-pan-progress-50", 900),
    ("tune-apu-pan-progress-75", 1350),
]
...
def main():
    ...
    with sync_playwright() as p:
        ...
        for label, y in POSITIONS:
            ...
            # Band detection: top_px > 0 means gap at top, bottom_px < viewH means gap at bottom
